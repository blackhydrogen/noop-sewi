(function() {
  var constants = {
    ...
    TEST_IMAGE_RESOURCE_DOM: '<div class="resource" data-res-id="b102a5e7-c845-4099-9449-3bfa246a83be" data-res-type="image" title=""><div class="resource-thumbnail-container"><img class="resource-thumbnail" src="/static/sewi/images/default_thumbnail.png"></div><p class="resource-title">SX SITE IMAGE</p></div>',
  ...
  QUnit.asyncTest('RG2: Loading resources into DOM', function(assert) {
    ...
    setTimeout(function() {
      ...
      assert.equal(resources[0].outerHTML, constants.TEST_IMAGE_RESOURCE_DOM, 'Image resource loaded');
      assert.equal(resources[1].outerHTML, constants.TEST_VIDEO_RESOURCE_DOM, 'Video resource loaded');
      assert.equal(resources[2].outerHTML, constants.TEST_AUDIO_RESOURCE_DOM, 'Audio resource loaded');
