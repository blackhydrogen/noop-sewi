...
(function() {
    ...
    sewi.constants = {
        ...
        RESOURCE_VIEWER_TOOLTIPS_BUTTON_DOM: '<button type="button" class="btn btn-default tooltips-button" title="Toggle Tooltips" data-toggle="button"><span aria-hidden="true" class="glyphicon glyphicon-info-sign"></span></button>',
        ...
        VIDEO_RESOURCE_VIEWER_RESET_ZOOM_BUTTON_DOM: '<button class="btn btn-default sewi-icon zoom-button"></button>',
        ...
        MEDIA_CONTROLS_PLAY_CLASS: 'video-icon play-button',
        MEDIA_CONTROLS_VOLUME_POPUP_CLASS: 'volume-popup',
        MEDIA_CONTROLS_MUTE_CLASS: 'video-icon mute-button',
